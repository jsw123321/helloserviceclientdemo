 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://hello.amarsoft.com/", wsdlLocation = "http://192.168.43.145:6788/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://hello.amarsoft.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.43.145:6788/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://hello.amarsoft.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hello.amarsoft.com/", "HelloServicePort"), HelloService.class, features);
    }
